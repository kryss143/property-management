...
export function loadBoardingHousesTable() {
  if (
    document.getElementById("bh-default-table") &&
    typeof DataTable !== "undefined"
  ) {
    let dataTable = new DataTable("#bh-default-table", {
      ...
      labels: {
        placeholder: "Search Boarding Houses...", // The search input placeholder
