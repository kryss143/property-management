...
export function loadApartmentsTable() {
  if (
    document.getElementById("apartments-default-table") &&
    typeof DataTable !== "undefined"
  ) {
    let dataTable = new DataTable("#apartments-default-table", {
      ...
      labels: {
        placeholder: "Search Apartments...", // The search input placeholder
