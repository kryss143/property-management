...
export function loadTownhousesTable() {
  if (
    document.getElementById("townhouses-default-table") &&
    typeof DataTable !== "undefined"
  ) {
    let dataTable = new DataTable("#townhouses-default-table", {
      ...
      labels: {
        placeholder: "Search Townhouses...", // The search input placeholder
