...
import { loadLineChart } from "../../api/DashboardLineChart.js";
import { loadColumnGraph } from "../../api/RevenueColumnGraph.js";
import { loadMonthlyColumnGraph } from "../../api/RevenueMonthlyGraph.js";
        ...
        <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
                ...
                <div>
                  <h5 class="inline-flex items-center text-gray-500 dark:text-gray-400 leading-none font-normal mb-2">
                    ...
                    <div
                      ...
                      id="clicks-info"
                      role="tooltip"
                      class="absolute z-40 invisible inline-block text-sm text-gray-500 transition-opacity duration-300 bg-white border border-gray-200 rounded-lg shadow-xs opacity-0 w-72 dark:bg-gray-800 dark:border-gray-600 dark:text-gray-400"
                    >
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div class="max-w-xxl w-full bg-white rounded-lg shadow-sm dark:bg-gray-800 p-4 md:p-6">
              ...
              <div id="column-chart-monthly"></div>
              <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
                <div class="flex justify-between items-center pt-5">
                  {/* <!-- Button --> */}
                  <button
