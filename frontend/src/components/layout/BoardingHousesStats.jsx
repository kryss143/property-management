...
import { loadBoardingHousesTable } from "../../api/BoardingHousesTable.js";
import { Link } from "react-router-dom";
import { FaPlus, FaEdit, FaTrashAlt } from 'react-icons/fa';

const BoardingHousesStats = () => {
  useEffect(() => {
    initFlowbite();
    loadBoardingHousesTable();
  }, []);
        ...
        <div class="p-2 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
          ...
          <div class="p-3 h-full rounded-sm bg-gray-50 dark:bg-gray-800">
            <div class="flex items-center justify-end mb-3">
              ...
              <button class="flex items-center justify-center gap-1 text-white bg-red-600 hover:bg-red-200 focus:ring-4 focus:ring-red-600 font-medium rounded-lg text-md px-4 py-2.5 mr-2 mb-3 dark:bg-red-600 dark:hover:bg-red-400 focus:outline-none dark:focus:ring-red-600">
                <FaTrashAlt />
                Delete Boarding House
              </button>
            </div>
            <table id="bh-default-table" class="border-gray-800 w-full">
              <thead>
                <tr>
                  <th>
...
export default BoardingHousesStats;
